...
export default function ActionButtons({ onDone, onPostpone, onRelease, compact = false }) {
  const base =
    'rounded-full h-11 px-5 text-[15px] font-medium transition active:scale-95 whitespace-nowrap'
  return (
